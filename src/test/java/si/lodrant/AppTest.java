...
public class AppTest {
	...
	public void addEmptyUser() {
		post("/users?username=").then()
				.assertThat()
				.body("status",
						equalTo("Bad Request(400): Cannot log you in if I do not know who you are (parameter missing)"))
				.statusCode(400)
				.contentType("application/json;charset=UTF-8");
	}
	...
	public void deleteNoParameterUser() {
		delete("/users?username=").then()
				.assertThat()
				.body("status",
						equalTo("Bad Request(400): Cannot delete you if I do not know who you are (parameter missing)"))
				.statusCode(400)
				.contentType("application/json;charset=UTF-8");
	}
	...
	public void sendGlobalMessage() {
		...
		given().body("{\"global\":true, \"recipient\":\"\", \"text\":\"bambam\"}")
				.contentType("application/json")
				.when()
				.post("/messages?username=miki")
				.then()
		...
		given().body("{\"global\":true, \"recipient\":\"hehe\", \"text\":\"bambam\"}")
				.contentType("application/json")
				.when()
				.post("/messages?username=miki")
				.then()
		...
		given().body("{\"global\":true, \"text\":\"bambam\"}")
				.contentType("application/json")
				.when()
				.post("/messages?username=miki")
				.then()
